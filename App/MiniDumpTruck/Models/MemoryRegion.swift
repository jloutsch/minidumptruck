...
public struct MemoryProtection: OptionSet {
    ...
    public static let readonly          = MemoryProtection(rawValue: 0x02)
    public static let readWrite         = MemoryProtection(rawValue: 0x04)
    public static let writeCopy         = MemoryProtection(rawValue: 0x08)
    public static let execute           = MemoryProtection(rawValue: 0x10)
    public static let executeRead       = MemoryProtection(rawValue: 0x20)
    public static let executeReadWrite  = MemoryProtection(rawValue: 0x40)
    public static let executeWriteCopy  = MemoryProtection(rawValue: 0x80)
    public static let guard_            = MemoryProtection(rawValue: 0x100)
    public static let noCache           = MemoryProtection(rawValue: 0x200)
    public static let writeCombine      = MemoryProtection(rawValue: 0x400)
...
public struct MemoryInfo: Identifiable {
    ...
    public let allocationProtect: MemoryProtection
    public let regionSize: UInt64
