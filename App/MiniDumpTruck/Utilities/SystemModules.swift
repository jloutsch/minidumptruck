...
public enum SystemModules {
    ...
    private static let windowsSystemModules: Set<String> = [
        ...
        // Windows Internals
        "win32u.dll", "cfgmgr32.dll", "setupapi.dll", "wintrust.dll",
        "imagehlp.dll", "dbghelp.dll", "version.dll", "psapi.dll",
        // IMM/Input
        "imm32.dll", "msctf.dll",
        // CLR/.NET
        "clr.dll", "clrjit.dll", "mscorwks.dll", "coreclr.dll", "mscoreei.dll",
        // DirectX Base
        "d3d11.dll", "d3d12.dll", "dxgi.dll", "d3d9.dll", "d3d10.dll",
        "d3d10_1.dll", "d2d1.dll", "dwrite.dll", "dcomp.dll",
        // Media Foundation
        "mf.dll", "mfplat.dll", "mfreadwrite.dll",
        // Windows Runtime
        "windowscodecs.dll", "propsys.dll", "profapi.dll",
        // Power/Performance
        "powrprof.dll", "ntmarta.dll"
    ]

    /// Known graphics drivers (special blame category)
    private static let graphicsDriverPatterns: Set<String> = [
        // Intel
        "igxelpicd64.dll", "igxelpicd32.dll", "igxelpgicd64.dll", "igxelpgicd32.dll",
        "ig9icd64.dll", "ig9icd32.dll", "igd10iumd64.dll", "igd10iumd32.dll",
        "igd11dxva64.dll", "igd12umd64.dll", "igdumdim64.dll", "igdumdim32.dll",
        "igdusc64.dll", "igc64.dll", "igc32.dll", "intelocl64.dll", "igdfcl64.dll",
        // NVIDIA
        "nvoglv64.dll", "nvoglv32.dll", "nvd3dumx.dll", "nvd3dum.dll",
        "nvwgf2umx.dll", "nvwgf2um.dll", "nvcuda64.dll", "nvcuda32.dll", "nvcuda.dll",
        "nvapi64.dll", "nvapi.dll", "nvinit.dll", "nvumdshimx.dll", "nvldumdx.dll",
        "nvopencl64.dll", "nvopencl32.dll",
        // AMD/ATI
        "aticfx64.dll", "aticfx32.dll", "atidxx64.dll", "atidxx32.dll",
        "amdxc64.dll", "amdxc32.dll", "amdvlk64.dll", "amdvlk32.dll",
        "atioglxx.dll", "atio6axx.dll", "atig6txx.dll", "atiumd64.dll", "atiumdag.dll",
        "amdocl64.dll", "amdocl.dll",
        // Vulkan loaders
        "vulkan-1.dll"
    ]
    ...
    public static func isSystemModule(_ moduleName: String) -> Bool {
    ...
    public static func isGraphicsDriver(_ moduleName: String) -> Bool {
        let short = shortName(from: moduleName)
        return graphicsDriverPatterns.contains(short)
    }

    /// Get module category for analysis
    public static func category(for moduleName: String) -> ModuleCategory {
        let short = shortName(from: moduleName)
