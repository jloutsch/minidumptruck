...
struct ExceptionInfo {
    ...
    let exceptionFlags: UInt32
    let exceptionRecord: UInt64  // Pointer to nested exception record
    let exceptionAddress: UInt64
    let numberOfParameters: UInt32
    let exceptionParameters: [UInt64]
    ...
    var accessViolationDetails: String? {
